...
<script>
    ...
    for (let i = 0; i < datas.length; i++) {
        ...
        for (let j = 0; j < plastiks.length; j++) {
            ...
            let progress_collection = t_baseline  + progress_incremental()
            ...
            let  kelebihan =  function () {
                let lebih = progress_collection - t_target;
                if (lebih <= 0){
                    return 0;
                }
                return lebih;
            ...
            $(`#plastiks-${i}`).append(`<tr><td><small class="th-small">${nama_plastik}-${t_pengumpulan}</small></td></tr>`)
...
@endcan
  ...
  let options = {
    ...
    "colReorder": true,
    buttons: dtButtons, scrollY: '70vh',
    scrollCollapse: true,
    paging:         false,
};
