        ...
        <form method="POST" action="{{ route("admin.suppliers.update", [$supplier->id]) }}"
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_supplier') ? 'is-invalid' : '' }}" type="text"
                    name="nama_supplier" id="nama_supplier" value="{{ old('nama_supplier', $supplier->nama_supplier) }}"
                    required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('jenis_usaha') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}"
                        {{ (old('jenis_usaha_id') ? old('jenis_usaha_id') : $supplier->jenis_usaha->id ?? '') == $id ? 'selected' : '' }}>
                        {{ $jenis_usaha }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" type="text" name="alamat"
                    id="alamat" value="{{ old('alamat', $supplier->alamat) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_telp') ? 'is-invalid' : '' }}" type="text" name="no_telp"
                    id="no_telp" value="{{ old('no_telp', $supplier->no_telp) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('jenis_plastiks') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}"
                        {{ (in_array($id, old('jenis_plastiks', [])) || $supplier->jenis_plastiks->contains($id)) ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sumber_sampahs') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}"
                        {{ (in_array($id, old('sumber_sampahs', [])) || $supplier->sumber_sampahs->contains($id)) ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lokasi_sumber_sampah') ? 'is-invalid' : '' }}" type="text"
                    ...
                    value="{{ old('lokasi_sumber_sampah', $supplier->lokasi_sumber_sampah) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_users') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}"
                        {{ (in_array($id, old('id_users', [])) || $supplier->id_users->contains($id)) ? 'selected' : '' }}>
                        {{ $id_user }}</option>
                    @endforeach
                </select>
