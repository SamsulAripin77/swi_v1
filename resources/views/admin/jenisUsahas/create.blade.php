...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.jenisUsaha.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.jenis-usahas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_usaha') ? 'is-invalid' : '' }}" type="text"
                    name="nama_usaha" id="naPma_usaha" value="{{ old('nama_usaha', '') }}" required>
