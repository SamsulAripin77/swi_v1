...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.buyers.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_buyer') ? 'is-invalid' : '' }}" type="text"
                    name="nama_buyer" id="nama_buyer" value="{{ old('nama_buyer', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_usaha') ? 'is-invalid' : '' }}" name="jenis_usaha_id"
                    id="jenis_usaha_id" required>
