        ...
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                    placeholder="nama" id="name" value="{{ old('name', '') }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('nama_usaha') ? 'is-invalid' : '' }}"
                    placeholder="Jenis Usaha" name="nama_usaha_id[]" id="nama_usaha_id" required multiple>
                    @foreach($nama_usahas as $id => $nama_usaha)
                    <option value="{{ $id }}" {{ in_array($id, old('nama_usaha_id', [])) ? 'selected' : '' }}>
                        {{ $nama_usaha }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('jenis_plastiks') ? 'is-invalid' : '' }}"
                    placeholder="jenis plastik" name="jenis_plastiks[]" id="jenis_plastiks" multiple required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" type="text" name="alamat"
                    placeholder="alamat" id="alamat" value="{{ old('alamat', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_tlp') ? 'is-invalid' : '' }}" type="text" name="no_tlp"
                    placeholder="no telepon" id="no_tlp" value="{{ old('no_tlp', '') }}" required>
...
<!-- {{-- <script>
    ...
    $('#nama_usaha_id').on('change', function () {
        $.ajax({
            url: '{{ route('admin.users.dependend-dropdown') }}',
method: 'POST',
data : {usahas: $(this).val()},
success: function (response) {
console.log(response);
// $('#jenis_plastiks').empty();
